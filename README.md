...
This repository contains the source code for the [SMC](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.smc.app.mobile).

Please see the [issues](https://github.com.smc.app.mobile/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about SMC? Ask away on the [com-smc-app-mobile discussion forum](https://groups.google.com/forum/#!forum/com-smc-app-mobile). 

<a href="https://play.google.com/store/apps/details?id=com.smc.app.mobile" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.smc.app.mobile__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.smc.app.mobile__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.smc.app.mobile.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall SMC from your device and
you will then be able to install your own built version.

## Acknowledgements

SMC is a result of a template project I've developed over the years as well as
...
SMC is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.smc.app.mobile/pulls).
